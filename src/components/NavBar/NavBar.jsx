...
const NavBar = () => {
	...
	return (
		<div className="max-w-[1440px] mx-auto flex justify-center items-center py-4">
			<div className="navbar bg-base-100 w-[95%] mx-auto flex justify-between items-center">
